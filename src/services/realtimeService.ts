// Compute WebSocket base URL from API base URL by replacing http with ws and removing /api/vX
const API_BASE = import.meta.env.VITE_API_BASE_URL || 'http://localhost:8000/api/v1';
const WS_BASE = import.meta.env.VITE_WS_URL || API_BASE.replace(/^http/, 'ws').replace(/\/api\/v\d+$/, '');
